  ...
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        // },
        {
          deviceType: "Wrist Band",
          deviceColor: "White",
          deviceImage: "bubbl/deviceimage/wristband/white_band.png",
          deviceDescription:
            "Crafted from high-quality, durable rubber, the Bubbl Band is built for longevity and comfort. Engineered with both style and endurance. Featuring advanced NFC tech, it’s the premium wearable that keeps you connected anytime, anywhere.",
          price: 2499,
          availability: true,
        },
        {
          deviceType: "Wrist Band",
          deviceColor: "Black",
          deviceImage: "bubbl/deviceimage/wristband/band_black.png",
          deviceDescription:
            "Crafted from high-quality, durable rubber, the Bubbl Band is built for longevity and comfort. Engineered with both style and endurance. Featuring advanced NFC tech, it’s the premium wearable that keeps you connected anytime, anywhere.",
          price: 2499,
          availability: true,
